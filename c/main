...
static char rcsid[] = "$Id: main.c,v 4.74 2004/03/26 22:34:19 hubert Exp $";
#endif
/*
...
"\tArgument\t\tMeaning",
#ifdef __riscos
"\t -A \t\tUse ANSI cursor control, not RISC OS",
#endif
...
char    *argv[];
{
    ...
    /* If we're in a taskwindow we don't have invert or anything :-( */
    if (taskwindow()) gmode|=MDSHOCUR;
...
#ifdef __riscos
          case 'A':
            gmode ^= MDUSEANSI;    /* Use ANSI instead of arc codes */
            break;
#endif
          case 'a':

...
#ifdef __riscos
/* On RISC OS we can (with ViewFinder and special systems) have modes that are
   more than 128 lines high. */
        signed int w_toprow;            /* Origin 0 top row of window   */
        signed int w_ntrows;            /* # of rows of text in window  */
#else
